...
describe('test-runner-playwright _electron', function testRunnerPlaywright() {
  this.timeout(100000);

  function createConfig() {
    return { browsers: [playwrightLauncher({ product: '_electron' })] };
  }
...
//           playwrightLauncher({ product: '_electron' }),
//         ],
//       };
//     }
