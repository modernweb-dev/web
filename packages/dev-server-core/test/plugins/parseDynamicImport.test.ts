...
import { parseDynamicImport } from '../../dist/plugins/parseDynamicImport.js';
...
describe('parseDynamicImport', () => {
  ...
  it('works for " string literals', () => {
    ...
    assert.deepEqual(testParseDynamicImport(importStringA), {
    ...
    assert.deepEqual(testParseDynamicImport(importStringB), {
    ...
    assert.deepEqual(testParseDynamicImport(importStringC), {
  ...
  it("works for ' string literals", () => {
    ...
    assert.deepEqual(testParseDynamicImport(importString), {
      importString,
      importSpecifier: './a.js',
      concatenatedString: false,
      stringLiteral: true,
