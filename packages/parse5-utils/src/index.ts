 ...
 */
function createScript(attrs: Record<string, string> = {}, code: string | undefined = undefined): Element {
...
export const createDocumentFragment: typeof adapter.createDocumentFragment = adapter.createDocumentFragment as any;
...
export const setTemplateContent: typeof adapter.setTemplateContent = adapter.setTemplateContent as any;
export const getTemplateContent: typeof adapter.getTemplateContent = adapter.getTemplateContent as any;
...
export const getTextNodeContent: typeof adapter.getTextNodeContent = adapter.getTextNodeContent as any;
export const getCommentNodeContent: typeof adapter.getCommentNodeContent = adapter.getCommentNodeContent as any;
export const getDocumentTypeNodeName: typeof adapter.getDocumentTypeNodeName = adapter.getDocumentTypeNodeName as any;
export const getDocumentTypeNodePublicId: typeof adapter.getDocumentTypeNodePublicId = adapter.getDocumentTypeNodePublicId as any;
export const getDocumentTypeNodeSystemId: typeof adapter.getDocumentTypeNodeSystemId = adapter.getDocumentTypeNodeSystemId as any;
...
export const isDocumentTypeNode: typeof adapter.isDocumentTypeNode = adapter.isDocumentTypeNode as any;
export const isElementNode: typeof adapter.isElementNode = adapter.isElementNode as any;
export const setNodeSourceCodeLocation: typeof adapter.setNodeSourceCodeLocation = adapter.setNodeSourceCodeLocation as any;
export const getNodeSourceCodeLocation: typeof adapter.getNodeSourceCodeLocation = adapter.getNodeSourceCodeLocation as any;
