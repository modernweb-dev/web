...
```js
import { http } from '@web/storybook-addon-mocks/http.js';
...
+import { mockPlugin } from '@web/storybook-addon-mocks/plugins.js';
...
+    const { mockRollupPlugin } = await import('@web/storybook-addon-mocks/plugins.js');
...
module.exports = {
  stories: ['../stories/**/*.stories.{js,md,mdx}'],
+  // for Storybook 9 (@web/storybook-builder)
+  addons: ['@web/storybook-addon-mocks/storybook-addon'],

-  // for Storybook 7 or 8 (@web/dev-server-storybook)
...
```js
import { registerMockRoutes } from '@web/storybook-addon-mocks/browser.js';
import { http } from '@web/storybook-addon-mocks/http.js';
import mocks from '../demo/mocks.js';
...
```js
import { registerMockRoutes } from '@web/storybook-addon-mocks/node.js';
import { http } from '@web/storybook-addon-mocks/http.js';
